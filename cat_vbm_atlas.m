...
cat.extopts.gcutstr      = 1;    % Strength of skull-stripping:               0 - SPM approach; eps to 1  - gcut; 2 - new APRG approach; -1 - no skull-stripping (already skull-stripped); default = 2
...
cat.extopts.atlas       = { ... 
  ...
  fullfile(cat.extopts.pth_templates,'hammers.nii')             0  {'csf','gm','wm'}   1; ... % atlas based on 30 subjects with 95 regions
  ...
  fullfile(cat.extopts.pth_templates,'ibsr.nii')                0  {'csf','gm','wm'}   1; ... % less regions, 18 subjects, low-res T1 image quality
  fullfile(cat.extopts.pth_templates,'aal3.nii')                1  {'gm'}              1; ... % many regions, but only labeled on one subject 
  fullfile(cat.extopts.pth_templates,'mori.nii')                1  {'gm','wm'}         1; ... % only one subject, but with WM regions
  fullfile(cat.extopts.pth_templates,'anatomy3.nii')            1  {'gm','wm'}         1; ... % 93 regions, 10 subjects
  fullfile(cat.extopts.pth_templates,'julichbrain.nii')         1  {'gm','wm'}         1; ... % many regions, 10 subjects
...
cat.output.atlas.native = 1; 
cat.output.atlas.warped = 1; 
cat.output.atlas.dartel = 1; 
